...
import {
  Home, User, Code, Mail, Github, Linkedin, Sun, Moon,
  ExternalLink, Send, ArrowUpRight, CheckCircle, XCircle
} from 'lucide-react';
...
const PROJECTS = [
    {
        ...
        description: "A complete overhaul of an existing e-commerce platform focusing on mobile-first experience and performance optimization. Technologies: React, Redux, Tailwind CSS.",
    ...
    },
    {
        ...
        description: "A web service utilizing the Gemini API to generate structured content from user prompts. Features token-based usage tracking. Technologies: Next.js, Gemini API, Firestore.",
    ...
    },
    {
        ...
        description: "A secure, real-time messaging application with private and group chat functionality. Technologies: Node.js, Socket.io, MongoDB.",
    ...
    },
    {
        ...
        description: "An interactive dashboard for complex data analysis built using D3.js and TypeScript. Focus on accessibility and dynamic filtering.",
...
const FirebaseContext = React.createContext({ db: null, auth: null, userId: null });
    ...
    return (
        <header className="fixed top-0 left-0 w-full z-50 backdrop-blur-md bg-white/80 dark:bg-gray-900/80 shadow-md transition-colors duration-500">
            <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex justify-between items-center h-16">
                <a href="#home" className="text-2xl font-extrabold tracking-tight text-gray-900 dark:text-white hover:text-indigo-600 dark:hover:text-indigo-400 transition">
                    [Your Name]
                </a>
                        ...
                        {navItems.map(item => (
                            ...
                            >
                                ...
                                <span className={`absolute bottom-0 left-0 h-0.5 w-full bg-indigo-600 dark:bg-indigo-400 
                                    transform scale-x-0 ${activeSection === item.id ? 'scale-x-100' : 'group-hover:scale-x-100'} 
        ...
        <div className="p-6">
            ...
            <div className="flex flex-wrap gap-2 mb-4">
                {project.tech.map((tech, index) => (
                    <span key={index} className="px-3 py-1 text-xs font-semibold bg-indigo-100 text-indigo-700 dark:bg-indigo-900 dark:text-indigo-300 rounded-full">
                        {tech}
                    </span>
                ))}
            </div>
...
const HeroSection = () => (
    <section id="home" className="min-h-screen pt-16 flex items-center justify-center text-center px-4">
        <div className="max-w-4xl mx-auto">
            ...
            <h1 className="text-5xl sm:text-7xl font-extrabold tracking-tight text-gray-900 dark:text-white leading-tight mb-6 animate-fadeInUp delay-200">
                Building <span className="text-indigo-600 dark:text-indigo-400">Modern Web Experiences</span> that scale.
            </h1>
            <p className="text-lg sm:text-xl text-gray-600 dark:text-gray-400 mb-10 max-w-2xl mx-auto animate-fadeInUp delay-400">
                A Full-Stack Developer specializing in React, Node.js, and cloud infrastructure, committed to clean code and exceptional user experience.
            </p>
            <a
                href="#projects"
        ...
        <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
                <div className="lg:col-span-2 space-y-6 text-lg text-gray-700 dark:text-gray-300">
                    <p>
                        My journey in web development began with a fascination for interactive applications. Over the years, I've cultivated a deep expertise in the **React ecosystem** for building robust, single-page applications. My focus is always on delivering high-performance, accessible, and maintainable codebases.
                    </p>
                    <p>
                        Beyond the frontend, I excel in backend development using **Node.js** and **Express**, with proficiency in both SQL (PostgreSQL) and NoSQL (Firestore, MongoDB) databases. I thrive in environments that prioritize continuous integration and deployment, and I'm always eager to adopt the latest technologies to solve complex problems.
                    </p>
                ...
                <div className="lg:col-span-1 bg-white dark:bg-gray-800 p-6 rounded-xl shadow-lg">
                    <h3 className="text-2xl font-semibold text-gray-900 dark:text-white mb-4">Core Skills</h3>
                    <div className="flex flex-wrap gap-3">
                        {["React.js", "Tailwind CSS", "Node.js", "TypeScript", "Firestore", "Next.js", "Redux", "Docker"].map((skill) => (
                            <span key={skill} className="px-4 py-1 text-sm font-medium bg-indigo-50 text-indigo-700 dark:bg-indigo-900 dark:text-indigo-200 rounded-full border border-indigo-200 dark:border-indigo-700 transition transform hover:scale-105">
                                {skill}
                            </span>
                        ))}
                    </div>
...
const ContactSection = () => {
    ...
    const StatusMessage = ({ type, message }) => (
        <div className={`flex items-center p-3 rounded-lg text-sm mb-4 ${
    ...
    return (
        <section id="contact" className="py-20 bg-gray-50 dark:bg-gray-900 px-4">
            <div className="max-w-3xl mx-auto">
                ...
                {status === 'success' && <StatusMessage type="success" message="Message sent successfully! I will respond shortly." />}
                {status === 'error' && <StatusMessage type="error" message="Failed to send message. Please check the console for details." />}

                <form onSubmit={handleSubmit} className="space-y-6 bg-white dark:bg-gray-800 p-8 rounded-xl shadow-2xl">
                    <div>
    ...
    <footer className="py-8 border-t border-gray-200 dark:border-gray-700/50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <div className="flex justify-center space-x-6 mb-4">
                <a href="https://github.com/placeholder" target="_blank" rel="noopener noreferrer" aria-label="GitHub" className="text-gray-400 hover:text-gray-900 dark:hover:text-white transition">
                    <Github className="w-6 h-6" />
                </a>
                <a href="https://linkedin.com/in/placeholder" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" className="text-gray-400 hover:text-blue-600 dark:hover:text-blue-400 transition">
